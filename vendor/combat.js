...
function calcul_fdc_def() {
    ...
    // Variation MJ
    fdc += parseInt(dialog_attaque_2.querySelector(".var_mj").value || 0);
...
function explications_fdc_def() {
    ...
    if (dialog_attaque_2.querySelector(".surprise_totale").checked) explication += `Surpise totale : FdC = 0<br>`;
        ...
        // Variation MJ
        if (dialog_attaque_2.querySelector(".var_mj").value !== "") {
            explication += `Variation MJ : ${parseInt(dialog_attaque_2.querySelector(".var_mj").value || 0)}<br>`;
            fdc += parseInt(dialog_attaque_2.querySelector(".var_mj").value || 0);
        }
...
function calcul_scr_att() {
    ...
    if (attaquant.at1_att && attaquant.Arme1) {
        if (attaquant.Arme1 === model_att.Arme_1) score += model_att.Att_1;
        else if (attaquant.Arme1 === model_att.Arme_2) score += model_att.Att_2;
        else if (attaquant.Arme1 === model_att.Arme_3) score += model_att.Att_3;
    }

    if (attaquant.at2_att && attaquant.Arme2) {
        if (attaquant.Arme2 === model_att.Arme_1) score += model_att.Att_1;
        else if (attaquant.Arme2 === model_att.Arme_2) score += model_att.Att_2;
        else if (attaquant.Arme2 === model_att.Arme_3) score += model_att.Att_3;
    }
...
function explications_scr_att() {
    ...
    let competence = 0;
    if (attaquant.at1_att && attaquant.Arme1) {
        if (attaquant.Arme1 === model_att.Arme_1) competence = model_att.Att_1 || 0;
        else if (attaquant.Arme1 === model_att.Arme_2) competence = model_att.Att_2 || 0;
        else if (attaquant.Arme1 === model_att.Arme_3) competence = model_att.Att_3 || 0;
    }
    else if (attaquant.at2_att && attaquant.Arme2) {
        if (attaquant.Arme2 === model_att.Arme_1) competence = model_att.Att_1 || 0;
        else if (attaquant.Arme2 === model_att.Arme_2) competence = model_att.Att_2 || 0;
...
function calcul_scr_def() {
    ...
    if (defenseur.pr1_def || defenseur.pr2_def) {
        ...
        if (defenseur.pr1_def && defenseur.Arme1) {
